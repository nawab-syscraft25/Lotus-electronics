...
application = DispatcherMiddleware(
    {},          # other apps can go here
    {'/chatbot': app}
)

# Optional local run for testing (not used in Gunicorn)
if __name__ == "__main__":
    run_simple("0.0.0.0", 8001, application, use_reloader=True, use_debugger=True, threaded=True)
